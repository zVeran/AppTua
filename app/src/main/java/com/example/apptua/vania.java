...
public class vania extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vania);
        ...
        bt4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(vania.this, personagens.class);
                startActivity(it);
                finish();
            }
        });
        ...
        bt6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(vania.this, MainActivity.class);
                startActivity(it);
                finish();
            }
        });
